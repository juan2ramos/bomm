    ...
    <form action="{{route('stepTwoPost')}}" enctype="multipart/form-data" method="post" id="upload_form"
        ...
        <div class="col-8 Form-inputs">
            <label for="nameRepresentative" class="row middle">
                @if(!empty($errors->get('name_representative')[0]))<p
                        class="Form-errors">{{$errors->get('name_representative')[0]}}</p>@endif
            ...
            <label for="lastNameRepresentative" class="row middle">
                @if(!empty($errors->get('last_name_representative')[0]))<p
                        class="Form-errors">{{$errors->get('last_name_representative')[0]}}</p>@endif
            ...
            <label for="identificationRepresentative" class="row middle">
                ...
                @if(!empty($errors->get('identification_representative')[0]))
                    <p class="Form-errors">{{$errors->get('identification_representative')[0]}}</p>
                @endif
            ...
            <label for="identificationNumberRepresentative" class="row middle">
                @if(!empty($errors->get('identification_number_representative')[0]))<p
                        class="Form-errors">{{$errors->get('identification_number_representative')[0]}}</p>@endif
            ...
            <label for="genderRepresentative" class="row middle">
                @if(!empty($errors->get('gender_representative')[0]))<p
                        class="Form-errors">{{$errors->get('gender_representative')[0]}}</p>@endif
            ...
            <label for="dayRepresentative" class="row middle">
                @if(!empty($errors->get('day_representative')[0]))<p
                        class="Form-errors">{{$errors->get('day_representative')[0]}}</p>@endif
            ...
            <label for="countryRepresentative" class="row middle">
                @if(!empty($errors->get('country_representative')[0]))<p
                        class="Form-errors">{{$errors->get('country_representative')[0]}}</p>@endif
            ...
            <label for="stateRepresentative" class="row middle">
                @if(!empty($errors->get('state_representative')[0]))<p
                        class="Form-errors">{{$errors->get('state_representative')[0]}}</p>@endif
            ...
            <label for="cityRepresentative" class="row middle">
                @if(!empty($errors->get('city_representative')[0]))<p
                        class="Form-errors">{{$errors->get('city_representative')[0]}}</p>@endif
            ...
            <label for="addressRepresentative" class="row middle">
                @if(!empty($errors->get('address_Representative')[0]))<p
                        class="Form-errors">{{$errors->get('address_Representative')[0]}}</p>@endif
            ...
            <label for="phoneRepresentative" class="row middle">
                @if(!empty($errors->get('phone_Representative')[0]))<p
                        class="Form-errors">{{$errors->get('phone_Representative')[0]}}</p>@endif
            ...
            <label for="levelEducationRepresentative" class="row middle">
                @if(!empty($errors->get('level_education_representative')[0]))<p
                        class="Form-errors">{{$errors->get('level_education_representative')[0]}}</p>@endif
            ...
            <label for="isCompany" class="row middle">
                @if(!empty($errors->get('is_company')[0]))<p
                        class="Form-errors">{{$errors->get('is_company')[0]}}</p>@endif
            ...
            <label for="companyRepresentative" class="row middle ">
                ...
                <input class="col-6 Company" disabled type="text" id="companyRepresentative" name="company_representative"
                       value="{{$r->company_representative }}">
            </label>
            <label for="nitCompany" class="row middle">
                <span class="col-5 cols-12">NIT:</span>
                <input class="col-6 Company" disabled type="text" id="nitCompany" name="nit_company" value="{{$r->nit_company }}">
            </label>
            <label for="positionCompany" class="row middle">
                <span class="col-5 cols-12">¿Qué cargo tienes en la empresa?</span>
                <select disabled id="positionCompany" class="col-6 cols-12 Company" name="position_company"
                        title="Selecciona la respuesta">
                    <option value="">Selecciona...</option>
