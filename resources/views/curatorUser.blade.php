    ...
    <div class="row" style="margin: auto;width:970px">
        ...
        <div class="col-8" style="margin-top: 20px">
            ...
            @if($view == 'social')
                ...
                @if($group->instagram)
                    Seguidores en Instagram : {{$group->instagram}}
                    <div  style="margin: 5px 0;">
                        <svg width="30px"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 90 112.5" enable-background="new 0 0 90 90" xml:space="preserve"><g><path d="M22.528,32.708c4.214-8.004,12.612-13.477,22.269-13.477s18.055,5.473,22.269,13.477h17.267V19.188   c0-7.467-6.053-13.521-13.521-13.521h-44.25v17.208h-1.844V5.667h-0.615v17.208H22.26V5.667h-0.615v17.208h-1.844V5.667h-0.615   v17.208h-1.844V5.795c-6.595,0.9-11.677,6.551-11.677,13.392v13.521H22.528z M64.052,14.098c0-1.602,1.298-2.9,2.9-2.9h6.492   c1.602,0,2.9,1.298,2.9,2.9v6.492c0,1.602-1.298,2.9-2.9,2.9h-6.492c-1.602,0-2.9-1.298-2.9-2.9V14.098z"/><path d="M68.643,36.396c0.844,2.512,1.308,5.197,1.308,7.99c0,13.87-11.284,25.154-25.154,25.154S19.643,58.256,19.643,44.385   c0-2.793,0.464-5.478,1.308-7.99H5.667v34.417c0,7.467,6.053,13.521,13.521,13.521h51.625c7.467,0,13.521-6.053,13.521-13.521   V36.396H68.643z"/><circle cx="44.797" cy="44.385" r="16.762"/></g></svg>
                        usuario : {{$group->instagram}}
                    </div>
                @endif
                @if($group->facebook)
                    <div  style="margin: 5px 0;">
                        <svg width="30px"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 125" enable-background="new 0 0 100 100" xml:space="preserve"><path fill="#3B5998" d="M95,58.698c0-2.575-1.059-5.011-2.857-6.772c1.287-1.63,2-3.643,2.016-5.773c0.018-2.448-0.96-4.793-2.752-6.597  c-1.861-1.874-4.418-2.948-7.02-2.948H63.972l1.313-8.516c0.168-1.076,0.248-2.177,0.248-3.267c0-8.425-5.689-18.217-13.021-18.217  c-2.122,0-4.189,0.749-5.817,2.107L45.94,9.347l1.065,13.998c0.045,0.598-0.002,1.19-0.14,1.76c-0.14,0.574-0.37,1.124-0.679,1.631  l-11.215,20.78l-4.196,3.59v34.363l2.941,1.336c0.273,0.124,0.563,0.32,0.911,0.616c4.007,3.407,9.185,3.447,9.404,3.447  l32.668-0.012l0.104-0.004c5.02-0.277,8.948-4.43,8.948-9.452c0-0.759-0.088-1.505-0.264-2.228c3.419-1.462,5.729-4.832,5.729-8.702  c0-1.283-0.254-2.524-0.745-3.682C93.249,65.102,95,62.075,95,58.698z M87.211,64.1l-2.593,0.807l1.633,2.166  c0.75,0.992,1.145,2.168,1.145,3.396c0,2.771-1.986,5.113-4.719,5.572l-2.592,0.431l1.209,2.334c0.422,0.81,0.636,1.686,0.636,2.593  c0,2.979-2.318,5.442-5.289,5.634l-32.605,0.014c-0.097-0.002-4.04-0.075-6.93-2.536c-0.625-0.533-1.201-0.912-1.809-1.186  l-0.699-0.319l0,0v-30.14l3.397-2.906l11.475-21.273c0.507-0.834,0.879-1.735,1.106-2.678c0.234-0.959,0.313-1.951,0.237-2.951  l-0.908-11.935c0.792-0.449,1.689-0.692,2.606-0.692c4.954,0,9.2,7.916,9.2,14.395c0,0.9-0.07,1.805-0.205,2.687l-1.993,12.92  h24.872c1.591,0,3.158,0.663,4.307,1.819c1.07,1.077,1.654,2.454,1.643,3.876c-0.011,1.764-0.83,3.392-2.245,4.464l-2.314,1.752  l2.524,1.434c1.775,1.004,2.876,2.893,2.876,4.923C91.177,61.188,89.583,63.359,87.211,64.1z M30.671,44.519H8.926  C6.76,44.519,5,46.281,5,48.446v41.018c0,2.164,1.76,3.928,3.926,3.928h21.746c2.165,0,3.928-1.764,3.926-3.928V48.446  C34.598,46.281,32.835,44.519,30.671,44.519z M22.316,86.248c-2.268,0-4.107-1.838-4.107-4.105s1.839-4.106,4.107-4.106  s4.106,1.839,4.106,4.106C26.422,84.411,24.584,86.248,22.316,86.248z"/></svg>
                         Seguidores en Facebook : <span id="facebook"></span> usuario : {{$group->facebook}}

                    </div>
                @endif
                @if($group->twitter)
                    <div  style="margin: 5px 0;">
                        <svg   width="30px"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 125" enable-background="new 0 0 100 100" xml:space="preserve"><path fill="#50a5e6" d="M72.955,17.969l-22.41,22.41c5.637,11.592,3.65,25.958-5.978,35.585c-9.45,9.451-23.469,11.543-34.946,6.285  c17.658,17.15,45.87,17.003,63.333-0.461C90.579,64.165,90.579,35.592,72.955,17.969z"/><path fill="#50a5e6" d="M58.281,47.966c-12.855,3.768-26.293-3.047-31.006-15.339c-7.596,6.311-11.149,16.751-8.194,26.831  c3.966,13.531,18.151,21.284,31.682,17.317c13.53-3.967,21.284-18.15,17.317-31.682c-0.197-0.676-0.428-1.333-0.675-1.979  C64.803,45.275,61.731,46.954,58.281,47.966z"/><circle fill="#50a5e6" cx="59.292" cy="32.235" r="19.743"/><polyline fill="#50a5e6" points="63.206,17.134 85.582,6.98 69.975,26.159 "/><polyline fill="#50a5e6" points="67.625,21.553 90,11.399 74.394,30.579 "/></svg>
                        Seguidores en Twitter : {{$t}} usuario : {{$group->twitter}}
                    </div>
                @endif
            @endif
